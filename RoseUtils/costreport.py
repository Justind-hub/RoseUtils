...
def run(self):
    try:
        ...
        wb.save(self.outputfolder + "Commodity Price Change Report" + datetime.now().strftime("%m.%d.%y")+".xlsx")
        self.ui.outputbox.setText("Running Commodity Price Change Report")
        self.ui.outputbox.append("Report ran, saved to " + self.outputfolder + "Commodity Price Change Report" + datetime.now().strftime("%m.%d.%y")+".xlsx")
        self.ui.outputbox.append("Opening file now...")
        startfile(self.outputfolder + "Commodity Price Change Report" + datetime.now().strftime("%m.%d.%y")+".xlsx")
    except:

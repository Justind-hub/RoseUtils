...
def run(self):
    try:
        ...
        ws.merge_cells(f"a18:{lastcol}18")
        ws.merge_cells(f"a35:{lastcol}35")
        ws.merge_cells(f"a52:{lastcol}52")
        ws.merge_cells(f"a69:{lastcol}69")
        ws.merge_cells(f"a86:{lastcol}86")
        ws.merge_cells(f"a103:{lastcol}103")

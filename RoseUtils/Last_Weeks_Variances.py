...
def run(self) -> None:
    try:
        ...
        rcp = self.rcp   
        storelist = ["1740","1743","2172","2174","02236","2272","02457","2549","2603","2953","3498","04778"] if rcp else \
                    ["2208","2306","2325","2478","2612","2618","2687","2921","3015","3130","3479","4405","5293"]
        
        storecols = {'1740': 2, '2172': 4,  '02236': 6,  '2272': 8,  '2549': 10, '2953': 12, 
                    '04778': 14, '1743': 16, '2174': 18, '02457': 20, '2603': 22, '3498': 24} if rcp else \

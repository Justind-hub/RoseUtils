...
def run(self) -> None:
    try:
        ...
        rcp = self.rcp   
        storelist = ["01740","1743","02172","2174","02236","02272","02457","02549","02603","2953","3498","04778"] if rcp else \
        ...
        storecols = {'01740': 2, '02172': 4,  '02236': 6,  '02272': 8,  '02549': 10, '2953': 12, 
                    '04778': 14, '1743': 16, '2174': 18, '02457': 20, '02603': 22, '3498': 24} if rcp else \
